...
class NotificationService:
    ...
    async def send_to_token(self, token: str, title: str, body: str, data: Optional[Dict[str, str]] = None) -> None:
        try:
    ...
    async def send_to_tokens(self, tokens: List[str], title: str, body: str, data: Optional[Dict[str, str]] = None) -> None:
        if not tokens:
            return
        try:
            from firebase_admin import messaging
    ...
    async def send_to_user(self, uid: str, title: str, body: str, data: Optional[Dict[str, str]] = None) -> None:
